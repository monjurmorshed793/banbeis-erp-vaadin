package bd.banbeis.gov.data.generator;

import bd.banbeis.gov.data.Role;
import bd.banbeis.gov.data.entity.SamplePerson;
import bd.banbeis.gov.data.entity.User;
import bd.banbeis.gov.data.service.SamplePersonRepository;
    ...
    public CommandLineRunner loadData(PasswordEncoder passwordEncoder, SamplePersonRepository samplePersonRepository,
        ...
        return args -> {
            ...
            ExampleDataGenerator<SamplePerson> samplePersonRepositoryGenerator = new ExampleDataGenerator<>(
                    SamplePerson.class, LocalDateTime.of(2022, 8, 5, 0, 0, 0));
